...
<head>
  ...
  <title>Você foi convidado para o ClosioCRM</title>
</head>
        ...
        <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
          ...
          <tr>
            <td style="background:#ffffff;padding:40px 40px 32px;border-left:1px solid #e8edf2;border-right:1px solid #e8edf2;">
              <h1 style="margin:0 0 8px;font-size:24px;font-weight:700;color:#111827;">Olá, ${userName}!</h1>
              <p style="margin:0 0 24px;font-size:15px;color:#6b7280;line-height:1.6;">
                Você foi adicionado ao workspace <strong style="color:#111827;">${workspaceName}</strong> no ClosioCRM.
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="padding:12px 0;border-bottom:1px solid #e2e8f0;">
                          <span style="font-size:11px;font-weight:600;color:#9ca3af;text-transform:uppercase;letter-spacing:0.5px;">Email de login</span><br/>
                          <span style="font-size:15px;font-weight:600;color:#111827;margin-top:2px;display:block;">${userEmail}</span>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-top:12px;">
                          ...
                          <span style="font-size:15px;font-weight:700;color:#2b7fff;font-family:monospace;letter-spacing:1px;margin-top:2px;display:block;">${tempPassword}</span>
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <tr>
            <td style="background:#f8fafc;border:1px solid #e8edf2;border-top:none;border-radius:0 0 16px 16px;padding:20px 40px;text-align:center;">
              ...
              <p style="margin:0;font-size:12px;color:#9ca3af;">
                Você recebeu este email porque foi convidado para o ClosioCRM.<br/>
